...
<title>Flowerily  by Free CSS Templates</title>
...
<!-- end #header-wrapper -->
<div id="logo">
	<h1><a href="#">Flowerily </a></h1>
	<p>template design by <a>Free CSS Templates</a></p>
		...
		<div id="page-bgtop">
			...
			<div id="content">
				<div class="post">
					...
					<h2 class="title"><a href="#">Welcome to Flowerily </a></h2>
					<p class="meta">Sunday, March 31, 2020 7:27 AM Posted by <a href="#">Someone</a></p>
					<div class="entry">
...
<div id="footer-bgcontent">
	<div id="footer">
		<p>Copyright (c) 2008 Sitename.com. All rights reserved. <br />
